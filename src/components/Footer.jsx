          ...
          <div>
            ...
            <div className="relative w-full max-w-xs">
              <input
                ...
                className="border border-[#9F9F9F] rounded-xl px-3 py-3 w-full focus:outline-none pr-28"
                value={email}
                onChange={(e) => setEmail(e.target.value)}
              />
              <button
                className="absolute top-1 bottom-1 right-1 bg-[#008080] text-white px-4 rounded-xl hover:bg-[#006666] transition-colors"
